<template>
    <v-container class="hinweise">
    <h1>Rechtliche Hinweise</h1>
    <div>
    <h2>1. Warnhinweis zu Inhalten</h2>
    <p>
        Die kostenlosen und frei zugänglichen Inhalte dieser 
        Webseite wurden mit größtmöglicher Sorgfalt erstellt.
         Der Anbieter dieser Webseite übernimmt jedoch keine Gewähr 
         für die Richtigkeit und Aktualität der bereitgestellten 
    ...
    <p>Diese Website enthält Verknüpfungen zu Websites Dritter ("externe Links"). 
        ...
        Der Anbieter hat bei der erstmaligen Verknüpfung der externen Links 
        die fremden Inhalte daraufhin überprüft, ob etwaige Rechtsverstöße bestehen. 
    ...
    <p>Die auf dieser Website veröffentlichten Inhalte unterliegen dem deutschen Urheber- 
        und Leistungsschutzrecht. Jede vom deutschen Urheber- und Leistungsschutzrecht nicht 
        zugelassene Verwertung bedarf der vorherigen schriftlichen Zustimmung des 
        ...
        Medien und Systemen. Inhalte und Rechte Dritter sind dabei als solche 
        gekennzeichnet. Die unerlaubte Vervielfältigung oder Weitergabe einzelner 
    ...
    <div>
    <h2>4. Besondere Nutzungsbedingungen[1]</h2>
    <p>Soweit besondere Bedingungen für einzelne Nutzungen dieser Website 
        ...
        entsprechender Stelle ausdrücklich darauf hingewiesen. 
        In diesem Falle gelten im jeweiligen Einzelfall die besonderen Nutzungsbedingungen.
    </p>
    </div>
    <p>Quelle: 
        <a href="http://www.juraforum.de/disclaimer_muster/">
        Juraforum.de
        </a>
    </p>   
    </v-container>
